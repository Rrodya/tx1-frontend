<template>
  <div class="driver-main py-20">
    <h1 class="text-center">Сделайте выбор.</h1>
    <h3 class="text-center mt-6"><br><br></h3>
...
<script lang="ts" src="./driver-main.ts"></script>
<style src="./driver-main.css"></style>
